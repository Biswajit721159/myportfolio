const projects = [
    ...
    },
    {
        ...
        url: 'https://book-bus-forkolkata.vercel.app/',
        gitHubLink: 'https://github.com/Biswajit721159/Book_Bus',
        TechStack: ['React Js', 'Node Js', 'Express Js', 'Redux JS', 'MongoDB', 'MUI', "TailWind CSS"],
    },
    {
...
const claName = " mt-5 bg-blue-600 text-white py-1.5 px-5 text-sm rounded-lg hover:bg-blue-500 focus:ring-4 focus:ring-blue-300 shadow-lg transform transition-transform hover:scale-105"

export { projects, claName }